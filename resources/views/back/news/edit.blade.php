    ...
    <div class="card card-primary">
        ...
        <form role="form" action="{{url('admin/news/edit/'.$News->RowID)}}" method="POST">
            <div class="card-body">
                ...
                <div class="form-group">
                    <label for="exampleInputEmail1">Mô tả tin tứcc<span class="color_red">*</span></label>
                    <textarea type="text" class="form-control" name="Description" rows = "10" value ="">{{$News->Description}} </textarea>
